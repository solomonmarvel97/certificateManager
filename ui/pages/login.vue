            ...
            <div class="form-wrapper">
              ...
              <div class="password-wrapper">
                ...
                <p
                  ...
                  :style="{
                    'background-image': 'url(' + passwordBackground + ')',
                  }"
...
export default {
  data() {
    return {
      passwordBackground: require("@/assets/icons/eye-slash.svg"),
  ...
  methods: {
    ...
    showOrHidePassword() {
      ...
      if (state === "text") {
        (this.passwordBackground = require("@/assets/icons/eye-slash.svg")),
